...
function Navbar(){
  ...
  return (
    <nav className="flex items-center px-13 bg-black/20 backdrop-blur-lg sticky top-0 z-50">
{/* Logo */}
    <div className="flex items-center text-2xl font-bold w-1/3">
...
*/}
  ...
  to="/"
    ...
    {/*<Link to="/login" className="text-white font font-medium hover:text-purple-500 py-2"  onClick={() => setIsOpen(false)}> Empecemos</Link> */}
  </div>)}
